...
<?php if($isClient && request()->is('client*') && $totalPending > 0): ?>
<style>
...
<div class="client-notif" aria-live="polite">
    <button id="clientNotifBtn" title="Notifications" aria-haspopup="true" aria-expanded="false">
        ...
        <span id="client-notification-badge" class="badge" style="display:<?php echo e($totalPending ? 'inline-block' : 'none'); ?>"><?php echo e($totalPending); ?></span>
    </button>
    ...
    <div id="clientNotifDropdown" class="dropdown" role="menu" aria-hidden="true">
        ...
        <div class="notifications-list">
            <?php if($totalPending > 0): ?>
                <?php if($pendingRequests > 0): ?>
                    <a href="<?php echo e(route('client.requests')); ?>" class="notification-item <?php echo e($pendingRequests > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($pendingRequests); ?> request<?php echo e($pendingRequests !== 1 ? 's' : ''); ?> pending review</div>
                ...
                <?php if($approvedRequests > 0): ?>
                    <a href="<?php echo e(route('client.requests')); ?>" class="notification-item <?php echo e($approvedRequests > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($approvedRequests); ?> request<?php echo e($approvedRequests !== 1 ? 's' : ''); ?> approved recently</div>
                            <div class="notification-time">View approved items</div>
                        </div>
                        <div class="notification-count"><?php echo e($approvedRequests); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($readyToReceive > 0): ?>
                    <a href="<?php echo e(route('client.requests')); ?>" class="notification-item <?php echo e($readyToReceive > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($readyToReceive); ?> request<?php echo e($readyToReceive !== 1 ? 's' : ''); ?> ready for pickup</div>
                            <div class="notification-time">Collect your items</div>
                        </div>
                        <div class="notification-count"><?php echo e($readyToReceive); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($rejectedRequests > 0): ?>
                    <a href="<?php echo e(route('client.requests')); ?>" class="notification-item <?php echo e($rejectedRequests > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($rejectedRequests); ?> request<?php echo e($rejectedRequests !== 1 ? 's' : ''); ?> not approved</div>
                            <div class="notification-time">Review request details</div>
                        </div>
                        <div class="notification-count"><?php echo e($rejectedRequests); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($lowInventory > 0): ?>
                    <a href="<?php echo e(route('client.inventory')); ?>" class="notification-item <?php echo e($lowInventory > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($lowInventory); ?> item<?php echo e($lowInventory !== 1 ? 's' : ''); ?> running low</div>
                            <div class="notification-time">Check inventory levels</div>
                        </div>
                        <div class="notification-count"><?php echo e($lowInventory); ?></div>
                    </a>
                <?php endif; ?>
        ...
        <div class="dropdown-footer">
            <a href="<?php echo e(route('client.notifications')); ?>">View All Notifications</a>
        </div>
    </div>
</div>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\inventory-system\resources\views/partials/client-notifications.blade.php ENDPATH**/ ?>