...
<div id="distributionModal">
    <div class="distribution-box">
        ...
        <div class="distribution-body">
            ...
            <?php if($approvedInventory->isEmpty()): ?>
                <div style="text-align:center; padding:40px; color:var(--muted);">
                    <div style="font-size:48px; margin-bottom:16px;">📭</div>
                    <p>No items are available in your inventory for distribution.</p>
                </div>
            <?php elseif($subaccounts->isEmpty()): ?>
                <div style="text-align:center; padding:40px; color:var(--muted);">
                    <div style="font-size:48px; margin-bottom:16px;">👥</div>
                    <p>Create a subaccount first before distributing items.</p>
                </div>
            <?php else: ?>
                <form method="POST" action="<?php echo e(route('client.account.distributeToSubaccounts')); ?>" style="display:grid; gap:20px;">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="subaccount_id_dist" name="subaccount_id" required style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
                                ...
                                <?php $__currentLoopData = $subaccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subaccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subaccount->id); ?>"><?php echo e($subaccount->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['subaccount_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="color: var(--danger); font-size: 12px;"><?php echo e($message); ?></span><?php unset($message);
                        ...
                        <div class="form-group">
                            ...
                            <select id="stock_request_item_id_dist" name="stock_request_item_id" required style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
                                <?php $__currentLoopData = $approvedInventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php if($myInventory > 0): ?>
                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->stock->description ?? $item->stock->name ?? 'Item'); ?> <?php if(isset($item->stock->price)): ?> (₱<?php echo e(number_format($item->stock->price, 2)); ?>) <?php endif; ?> — available: <?php echo e($myInventory); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="allocated_qty_dist" name="allocated_qty" min="1" required value="<?php echo e(old('allocated_qty', 1)); ?>" style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
                        <?php $__errorArgs = ['allocated_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="color: var(--danger); font-size: 12px;"><?php echo e($message); ?></span><?php unset($message);
...
<div id="addMemberModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.6); backdrop-filter:blur(4px); z-index:5000; align-items:center; justify-content:center; padding:20px; animation:fadeIn .3s ease;">
    <div class="distribution-box">
        ...
        <div class="distribution-body">
            ...
            <form method="POST" action="<?php echo e(route('client.account.members.store')); ?>" style="display:grid; gap:20px;">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    ...
                    <input type="text" id="member_name_modal" name="name" placeholder="e.g. John Doe" required value="<?php echo e(old('name')); ?>" style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
                    <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <span style="color: var(--danger); font-size: 12px;"><?php echo e($message); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="member_email_modal" name="email" placeholder="Enter member email" required value="<?php echo e(old('email')); ?>" style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
            ...
            <?php else: ?>
                <form id="distributeToMemberForm" style="display:grid; gap:20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="distributed_qty_member_dist_modal" name="distributed_qty" min="1" required value="<?php echo e(old('distributed_qty', 1)); ?>" style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
...
<div id="deductModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.6); backdrop-filter:blur(4px); z-index:5000; align-items:center; justify-content:center; padding:20px; animation:fadeIn .3s ease;">
    <div class="distribution-box">
        ...
        <div class="distribution-body">
            ...
            <form method="POST" action="<?php echo e(route('client.account.deductItems')); ?>" style="display:grid; gap:20px;">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="deduct_qty" name="deducted_qty" min="1" required value="<?php echo e(old('deducted_qty', 1)); ?>" style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
                    <?php $__errorArgs = ['deducted_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="color: var(--danger); font-size: 12px;"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="received_by" name="received_by" required value="<?php echo e(old('received_by', Auth::user()->name)); ?>" placeholder="Enter your name" style="width:100%; padding:12px; border:1px solid var(--line); border-radius:10px; font-size:14px; background:#fff; transition:border-color .2s ease;">
...
<div class="account-container">
    ...
    <div style="max-width: 1000px; margin: 0 auto 40px; margin-bottom: 40px;">
        ...
        <div style="display: grid; gap: 16px;">
            <div style="background: rgba(255,255,255); border: 1px solid var(--line); border-radius: 14px; padding: 18px;">
                ...
                <p style="color: var(--text); font-size: 16px; font-weight: 700; margin: 0;"><?php echo e(auth()->user()->name); ?></p>
            </div>

            <div style="background: rgba(255,255,255); border: 1px solid var(--line); border-radius: 14px; padding: 18px;">
                <p style="color: var(--muted); font-size: 12px; font-weight: 700; margin: 0 0 6px; text-transform: uppercase;">Account Type</p>
                <p style="color: var(--text); font-size: 16px; font-weight: 700; margin: 0;"><?php echo e(ucfirst(auth()->user()->role)); ?></p>
            </div>

            <div style="background: rgba(255,255,255); border: 1px solid var(--line); border-radius: 14px; padding: 18px;">
                <p style="color: var(--muted); font-size: 12px; font-weight: 700; margin: 0 0 6px; text-transform: uppercase;">Member Since</p>
                <p style="color: var(--text); font-size: 16px; font-weight: 700; margin: 0;"><?php echo e(auth()->user()->created_at->format('M d, Y')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div style="max-width: 1000px; margin: 0 auto;">
        ...
        <div style="background: rgba(255,255,255); border: 1px solid var(--line); border-radius: 14px; padding: 24px; margin-bottom: 20px;">
            ...
            <p style="color: var(--muted); margin: 0 0 16px; font-size: 14px;"><?php echo e(auth()->user()->email); ?></p>
    ...
    <div id="emailModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.5); z-index:5000; align-items:center; justify-content:center;">
        <div style="background:#fff; border-radius:14px; box-shadow:0 10px 40px rgba(0,0,0,.25); max-width:450px; width:90%; padding:24px; animation: slideIn 0.3s ease;">
            ...
            <form method="POST" action="<?php echo e(route('client.account.updateEmail')); ?>" id="emailForm">
                <?php echo csrf_field(); ?>
                
                <div class="form-group">
                    <label for="current_email_display">Current Email</label>
                    <input type="email" id="current_email_display" value="<?php echo e(auth()->user()->email); ?>" disabled>
                </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="passwordModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.5); z-index:5000; align-items:center; justify-content:center;">
        <div style="background:#fff; border-radius:14px; box-shadow:0 10px 40px rgba(0,0,0,.25); max-width:450px; width:90%; padding:24px; animation: slideIn 0.3s ease;">
            ...
            <form method="POST" action="<?php echo e(route('client.account.updatePassword')); ?>" id="passwordForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($activeTab === 'inventory' && auth()->user()->role === 'client'): ?>
    <div class="account-container">
                
        <!-- Report Generator content moved into Distribution details main content -->
        <?php if(isset($mainInventoryTotals) && isset($memberInventoryTotals)): ?>
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:16px; gap:16px;">
                    <div style="display:flex; gap:12px; align-items:flex-end; flex-wrap:wrap;">
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <input type="date" id="date_from" name="date_from" value="<?php echo e(request('date_from')); ?>" style="padding:8px 12px; border:1px solid var(--line); border-radius:8px; font-size:13px; background:white; color:var(--text); min-width:150px;">
                        </div>
                        <div class="form-group" style="margin-bottom:0;">
                            <label for="date_to" style="display:block; margin-bottom:4px; color:var(--text); font-weight:600; font-size:13px;">To Date</label>
                            <input type="date" id="date_to" name="date_to" value="<?php echo e(request('date_to')); ?>" style="padding:8px 12px; border:1px solid var(--line); border-radius:8px; font-size:13px; background:white; color:var(--text); min-width:150px;">
                        </div>
                    ...
                    <div style="display:flex; gap:10px; align-items:center;">
                        <a href="<?php echo e(route('client.account.report.pdf')); ?>?<?php echo e(http_build_query(request()->only(['date_from', 'date_to']))); ?>" class="btn-submit" style="padding:8px 16px; font-size:13px; display:flex; align-items:center; gap:6px; text-decoration:none;">
                ...
                <div id="inventoryReport" style="display:block; padding:24px;">
                    <div style="display:grid; gap:20px;">
                            ...
                            <div class="report-card">
                                ...
                                <div class="report-card-body" style="padding:20px;">
                                    <div class="report-stat">
                                        ...
                                        <span class="stat-value" style="color:#1e40af; font-weight:700; font-size:18px;"><?php echo e($mainInventoryTotals['total_received']); ?></span>
                                    </div>
                                    <div class="report-stat">
                                        <span class="stat-label" style="color:#059669; font-weight:600;">Available:</span>
                                        <span class="stat-value text-success" style="background:linear-gradient(135deg, #ecfdf5, #d1fae5); color:#059669; font-weight:700; font-size:18px;"><?php echo e($mainInventoryTotals['total_available']); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="report-section">
                            ...
                            <?php if(isset($memberReports) && $memberReports->isNotEmpty()): ?>
                                <div style="overflow-x:auto; border-radius:16px; box-shadow:0 8px 25px rgba(59,130,246,0.15); background:linear-gradient(135deg, #eff6ff, #dbeafe);">
                                    <table class="report-table" style="width:100%; border-collapse:collapse;">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $memberReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memberReport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr style="border-bottom:1px solid #e0e7ff; background:linear-gradient(135deg, #ffffff, #f8fafc);">
                                                    <td style="padding:14px 10px; border-bottom:1px solid #e0e7ff; font-weight:700; color:#1e40af; font-size:14px;"><?php echo e($memberReport['name']); ?></td>
                                                    <td style="padding:14px 10px; border-bottom:1px solid #e0e7ff; color:#475569; font-size:13px;"><?php echo e($memberReport['email']); ?></td>
                                                    <td style="padding:14px 10px; text-align:right; border-bottom:1px solid #e0e7ff; color:#1e40af; font-weight:700;"><?php echo e($memberReport['distributed_items']); ?></td>
                                                    <td style="padding:14px 10px; text-align:right; border-bottom:1px solid #e0e7ff; color:#059669; font-weight:700; background:linear-gradient(135deg, #ecfdf5, #d1fae5);"><?php echo e($memberReport['available_items']); ?></td>
                                                    <td style="padding:14px 10px; text-align:right; border-bottom:1px solid #e0e7ff; color:#ea580c; font-weight:700; background:linear-gradient(135deg, #fff7ed, #fed7aa);"><?php echo e($memberReport['used_items']); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <div style="overflow-x:auto; border-radius:12px; box-shadow:0 4px 12px rgba(59,130,246,0.1); background:linear-gradient(135deg, #f8fafc, #e2e8f0);">
                                        <table class="report-table" style="width:100%; border-collapse:collapse;">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $approvedInventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr style="border-bottom:1px solid #e0e7ff; background:linear-gradient(135deg, #ffffff, #f8fafc);">
                                                        <td style="padding:10px 8px; border-bottom:1px solid #e0e7ff; color:#374151; font-size:12px; font-weight:500;"><?php echo e($item->stock->description ?? 'Unknown Item'); ?></td>
                                                        <td style="padding:10px 8px; text-align:right; border-bottom:1px solid #e0e7ff; color:#1e40af; font-weight:600; font-size:12px;"><?php echo e($item->approved_qty ?? 0); ?></td>
                                                        <td style="padding:10px 8px; text-align:right; border-bottom:1px solid #e0e7ff; color:#ea580c; font-weight:600; font-size:12px;"><?php echo e($item->distributed_qty ?? 0); ?></td>
                                                        <td style="padding:10px 8px; text-align:right; border-bottom:1px solid #e0e7ff; color:#059669; font-weight:700; font-size:12px; background:linear-gradient(135deg, #ecfdf5, #d1fae5);"><?php echo e($item->my_inventory ?? 0); ?></td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                        </table>
                                            ...
                                            <?php if($memberItems->isNotEmpty()): ?>
                                                <div style="border-radius:12px; box-shadow:0 4px 12px rgba(16,185,129,0.1); background:linear-gradient(135deg, #f0fdf4, #dcfce7); overflow:hidden;">
                                                    <div style="padding:12px; background:linear-gradient(135deg, #059669, #047857); color:white;">
                                                        <h6 style="margin:0; font-size:14px; font-weight:600;"><?php echo e($member->name); ?></h6>
                                                        <p style="margin:4px 0 0 0; font-size:11px; opacity:0.9;"><?php echo e($member->email); ?></p>
                                                    </div>
                                                            ...
                                                            <tbody>
                                                                <?php $__currentLoopData = $memberItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr style="border-bottom:1px solid #bbf7d0;">
                                                                        <td style="padding:4px; color:#064e3b; font-weight:500;"><?php echo e($item->description); ?></td>
                                                                        <td style="padding:4px; text-align:right; color:#1e40af;"><?php echo e($item->distributed_qty); ?></td>
                                                                        <td style="padding:4px; text-align:right; color:#ea580c;"><?php echo e($item->used_qty); ?></td>
                                                                        <td style="padding:4px; text-align:right; color:#059669; font-weight:600;"><?php echo e($item->available_qty); ?></td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </tbody>
                                                        </table>
    ...
    <?php if($activeTab === 'members' && auth()->user()->role === 'client'): ?>
    ...
    <div style="display: flex; gap: 12px; margin-bottom: 24px;">
        ...
        <?php if(!$clientMembers->isEmpty() && !$approvedInventory->isEmpty()): ?>
    ...
    <div class="settings-card">
        <div class="card-header" style="cursor: default; background: linear-gradient(135deg, rgba(37,99,235,.08), rgba(37,99,235,.04));">
            ...
            <span style="color: var(--muted); font-size: 14px; font-weight: 600;">
                <?php echo e($clientMembers->count()); ?> member<?php echo e($clientMembers->count() !== 1 ? 's' : ''); ?>

            </span>
        </div>
        <div class="card-body open" style="display: block;">
            <?php if($clientMembers->isEmpty()): ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $memberReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memberReport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr style="border-bottom:1px solid #e0e7ff; background:linear-gradient(135deg, #ffffff, #f8fafc);">
                                    ...
                                    <?php if($memberReport['distributed_items'] > 0): ?>
                                        <div style="position:relative; display:inline-block; margin-left:8px;">
                                            <button 
                                                type="button" 
                                                onclick="toggleMemberItemsDropdown('member-items-<?php echo e($memberReport['name']); ?>')"
                                    ...
                                    <?php echo e($memberReport['used_items']); ?>

                                </td>
                                    <td style="padding:12px; border:1px solid var(--line);">
                                        <div style="display:flex; gap:6px; flex-wrap:wrap; justify-content:center;">
                                            <button type="button" class="btn-action" style="padding:6px 12px; font-size:12px; background:#3b82f6; color:white; border:none; border-radius:6px; cursor:pointer;" onclick="openEditMemberModal(<?php echo e($currentMember->id); ?>, '<?php echo e($currentMember->name); ?>', '<?php echo e($currentMember->email); ?>')">
                                                Edit
                                            </button>
                                            <?php if($memberReport['available_items'] > 0): ?>
                                            <button type="button" class="btn-action" style="padding:6px 12px; font-size:12px; background:#dc2626; color:white; border:none; border-radius:6px; cursor:pointer;" onclick="openDeductModal(<?php echo e($currentMember->id); ?>, '<?php echo e($memberReport['name']); ?>', <?php echo e($memberReport['available_items']); ?>)">
                                                Deduct
                                            </button>
                                            <?php endif; ?>
                                            <button type="button" class="btn-action" style="padding:6px 12px; font-size:12px; background:#ef4444; color:white; border:none; border-radius:6px; cursor:pointer;" onclick="openDeleteMemberModal(<?php echo e($currentMember->id); ?>, '<?php echo e($currentMember->name); ?>')">
                                                Delete
                                            </button>
                                        </div>
                                    </td>
    ...
    <?php if($activeTab === 'subaccounts' && auth()->user()->role === 'client'): ?>
    <div class="settings-card">
        ...
        <div id="subaccounts-card" class="card-body open">
            ...
            <form method="POST" action="<?php echo e(route('client.account.subaccounts.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label for="subaccount_name">Office Name</label>
                    <input type="text" id="subaccount_name" name="name" placeholder="e.g. Main Office, Branch Office" required value="<?php echo e(old('name')); ?>">
                    <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="subaccount_email" name="email" placeholder="Enter email for subaccount login" required value="<?php echo e(old('email')); ?>">
                    <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea id="subaccount_description" name="description" placeholder="Brief description of this office" rows="3"><?php echo e(old('description')); ?></textarea>
                            ...
                            <?php $__currentLoopData = $subaccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subaccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr style="border-bottom:1px solid #e0e7ff; background:linear-gradient(135deg, #ffffff, #f8fafc);">
                                    <td style="padding:14px 10px; border-bottom:1px solid #e0e7ff; font-weight:700; color:#1e40af; font-size:14px;">
                                        <?php echo e($subaccount->name); ?>

                                        <?php if($subaccount->description): ?>
                                            <div style="color:#64748b; font-size:11px; margin-top:4px;"><?php echo e($subaccount->description); ?></div>
                                        <?php endif; ?>
                                    </td>
                                    <td style="padding:14px 10px; border-bottom:1px solid #e0e7ff; color:#475569; font-size:13px;"><?php echo e($subaccount->user->email ?? 'No login email'); ?></td>
                                    <td style="padding:14px 10px; text-align:center; border-bottom:1px solid #e0e7ff; color:#1e40af; font-weight:700;"><?php echo e($subaccount->members_count); ?></td>
                                    <td style="padding:14px 10px; text-align:center; border-bottom:1px solid #e0e7ff; color:#1e40af; font-weight:700;"><?php echo e($allocationCount); ?></td>
                                    <td style="padding:14px 10px; border-bottom:1px solid #e0e7ff;">
                                        <a href="<?php echo e(route('client.account.subaccounts.show', $subaccount)); ?>" style="color:#3b82f6; text-decoration: none; font-weight: 600; background:linear-gradient(135deg, #eff6ff, #dbeafe); padding:6px 12px; border-radius:6px; display:inline-block;">Manage</a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
...
<?php $__currentLoopData = $memberReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memberReport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- Backdrop -->
    <div id="member-items-backdrop-<?php echo e($memberReport['name']); ?>" 
    ...
    <!-- Popup Window -->
    <div id="member-items-<?php echo e($memberReport['name']); ?>" 
        ...
        <div style="padding:16px; border-bottom:1px solid #e2e8f0; background:#f8fafc; border-radius:12px 12px 0 0; display:flex; justify-content:space-between; align-items:center;">
            <div>
                <div style="font-weight:700; color:#1e40af; font-size:16px;"><?php echo e($memberReport['name']); ?></div>
                <div style="color:#64748b; font-size:13px; margin-top:2px;"><?php echo e($memberReport['email']); ?></div>
            </div>
            <button type="button" onclick="toggleMemberItemsDropdown('member-items-<?php echo e($memberReport['name']); ?>')" style="background:none; border:none; color:#64748b; cursor:pointer; padding:6px 8px; border-radius:6px; font-size:20px; line-height:1;" onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='none'">×</button>
        </div>
                ...
                <div style="padding:8px 12px;">
                    ...
                    <?php $__currentLoopData = $allItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="padding:8px; margin-bottom:6px; border:1px solid #e5e7eb; border-radius:6px; background:#f9fafb;">
                            <div style="font-weight:600; color:#1f2937; font-size:12px; margin-bottom:4px;"><?php echo e($item->name); ?></div>
                            
                            <?php if($item->has_distributed): ?>
                                <div style="display:flex; gap:12px; font-size:11px; color:#6b7280; margin-bottom:2px;">
                                    <span><strong>Quantity:</strong> <?php echo e($item->distributed_qty); ?></span>
                                    <span><strong>Available:</strong> <span style="color:#059669; font-weight:600;"><?php echo e($item->available_qty); ?></span></span>
                                </div>
                            <?php endif; ?>
                            
                            <?php if($item->has_deducted): ?>
                                <div style="font-size:11px; color:#6b7280;">
                                    <span><strong>Deducted:</strong> <?php echo e($item->deducted_qty); ?> units</span>
                                </div>
                            <?php endif; ?>
                            
                            <?php if($item->has_distributed && $item->has_deducted): ?>
        ...
        <div style="padding:16px; background:#f8fafc; border-radius:0 0 12px 12px; border-top:1px solid #e2e8f0;">
            <div style="font-size:12px; color:#64748b; text-align:center;">
                ...
                <div style="font-size:13px;">
                    Total Received: <?php echo e($memberReport['distributed_items']); ?> | 
                    Total Used: <?php echo e($memberReport['used_items']); ?> | 
                    <span style="color:#059669; font-weight:700;">Available: <?php echo e($memberReport['available_items']); ?></span>
                </div>
                <?php if($memberReport['distributed_items'] > 0): ?>
                    <div style="margin-top:6px; font-size:11px; color:#94a3b8;">
                        (<?php echo e($memberReport['available_items']); ?> of <?php echo e($memberReport['distributed_items']); ?> items remaining)
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
function updateMembers() {
    ...
    const subaccountMembers = <?php echo json_encode($subaccountMembers, 15, 512) ?>;
...
function submitDistributeToMember() {
    ...
    fetch('<?php echo e(route("client.account.distributeToMember")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
function openDeductModal(memberId, memberName, availableQty) {
    ...
    const members = <?php echo json_encode($clientMembers, 15, 512) ?>;
    ...
    if (member) {
        ...
        const memberReports = <?php echo json_encode($memberReports, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\inventory-system\resources\views/client/account.blade.php ENDPATH**/ ?>