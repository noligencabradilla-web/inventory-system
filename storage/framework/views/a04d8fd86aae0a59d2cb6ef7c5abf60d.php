...
<div style="overflow:auto; border-radius:14px; border:1px solid #e2e8f0;">
    <table>
        ...
        <?php $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($s->stock > 0): ?>
            <tr>
                <td><b><?php echo e($s->id_no); ?></b></td>
                <td><?php echo e($s->description); ?></td>
                <td><?php echo e($s->category?->name ?? 'Unknown'); ?></td>
                <td><?php echo e($s->unit); ?></td>
                <td>
                    <?php if($s->stock >= 50): ?>
                        <span class="pill ok"><?php echo e($s->stock); ?></span>
                    <?php else: ?>
                        <span class="pill low"><?php echo e($s->stock); ?></span>
                    <?php endif; ?>
                </td>
            </tr>
            <?php endif; ?>
...
<div class="modal" id="reqModal">
    <div class="modal-card">
        ...
        <form method="POST" action="<?php echo e(route('client.requests.store')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-body">
                ...
                <div>
                    <div class="field" style="align-items: flex-start;">
                        ...
                        <div class="muted" style="margin-top: 0;"><?php echo e(Auth::user()->office ?? '-'); ?></div>
                    ...
                    <div class="field">
                        ...
                        <textarea name="reason" placeholder="Please provide a reason for this request..." style="width:100%; padding:10px; border:2px solid #e2e8f0; border-radius:10px; font-size:13px; background:#ffffff; min-height:60px; resize:vertical;"><?php echo e(old('reason')); ?></textarea>
...
const STOCKS = <?php echo json_encode($stocksJson, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\inventory-system\resources\views/client/stocks/index.blade.php ENDPATH**/ ?>