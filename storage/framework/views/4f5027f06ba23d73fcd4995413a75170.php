...
<?php $__env->startSection('content'); ?>
    <h2 class="page-heading">Welcome, <?php echo e(auth()->user()->name); ?></h2>
        ...
        <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quickLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="quick-card">
                ...
                <div class="quick-title">
                    <span><?php echo e($quickLink['title']); ?></span>

                    <?php if(!empty($quickLink['badge']) && $quickLink['badge'] > 0): ?>
                        <span class="badge"><?php echo e($quickLink['badge']); ?></span>
                    <?php endif; ?>
                </div>

                <a href="<?php echo e($quickLink['url']); ?>" class="quick-link">Open →</a>
            </div>
    ...
    <div class="charts-grid" id="chartsGrid">
        <?php $__currentLoopData = $chartCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="chart-card" id="<?php echo e($chart['id']); ?>" data-chart-type="<?php echo e($chart['type']); ?>">
                <div class="chart-header">
                    <div>
                        <h3 class="chart-title"><?php echo e($chart['title']); ?></h3>
                        <div class="chart-sub"><?php echo e($chart['subtitle']); ?></div>
                    </div>
                    <div class="chart-icon"><?php echo e($chart['icon']); ?></div>
                </div>

                <div class="chart-body">
                    <canvas id="<?php echo e($chart['canvas']); ?>"></canvas>
                    <div class="chart-loading-overlay" id="<?php echo e($chart['loading']); ?>">
                        <div class="spinner"></div>
                        <div class="loading-text">Loading data...</div>
                    </div>
                </div>

                <?php if(!empty($chart['summary'])): ?>
                    <div id="<?php echo e($chart['summary']); ?>" class="chart-summary"></div>
                <?php endif; ?>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <script id="dashboardChartData" type="application/json">
        <?php echo json_encode($dashboardChartData, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_AMP | JSON_HEX_QUOT); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\inventory-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>