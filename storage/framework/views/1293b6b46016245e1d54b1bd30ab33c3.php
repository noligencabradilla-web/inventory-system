...
<head>
    ...
    <style>
        ...
        * {
        ...
        .nav a.logout-link svg {
            width: 18px;
            height: 18px;
            margin: 0;
        }

        .nav a.logout-link span {
            display: none;
        }
        ...
        .nav a.logout-link:hover {
            ...
            color: #b91c1c;
            background: linear-gradient(90deg, rgba(254, 202, 202, 0.45), rgba(254, 226, 226, 0.25));
        }
        ...
        @media (min-width: 641px) {
            ...
            .sidebar.client-sidebar .nav::-webkit-scrollbar {
                display: none;
            }
            ...
            .sidebar:not(.client-sidebar) .nav::-webkit-scrollbar {
                display: none;
            }
        ...
        @media (max-width: 640px) {
            ...
            .sidebar .nav a.logout-link span {
                display: none;
            }
...
<body>
            ...
            <div class="brand">
                <div style="display: flex; flex-direction: column; align-items: center; gap: 4px; margin-bottom: 8px;">
                    <img src="/images/brand-logo.png" alt="Logo"
                        style="width: 55%; height: 122; object-fit: contain;">
            ...
            <nav class="nav">
                ...
                <a href="#" class="logout-link" id="sidebar-logout" aria-haspopup="dialog" title="Logout">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                        ...
                        <path d="M5.5 8.5a7 7 0 1 0 13 0" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                    <span>Logout</span>
                </a>
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>" onsubmit="showLoading('Logging out...')">
                    ...
                    <button class="logout-btn" type="submit" aria-label="Logout">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M12 2v10" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M5.5 8.5a7 7 0 1 0 13 0" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </button>
                </form>
    ...
    <div id="logoutConfirmModal"
        style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.45); z-index:12000; align-items:center; justify-content:center;">
        <div
            style="background:#fff; border-radius:12px; box-shadow:0 18px 60px rgba(2,6,23,.35); max-width:420px; width:92%; padding:20px;">
            <div style="display:flex; align-items:center; gap:12px;">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2v10" stroke="#fb923c" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M5.5 8.5a7 7 0 1 0 13 0" stroke="#fb923c" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <div>
            ...
            <div style="display:flex; gap:10px; justify-content:flex-end; margin-top:18px;">
                <button id="logoutCancelBtn"
                    style="padding:8px 14px; border-radius:10px; border:1px solid #e2e8f0; background:#fff; color:#0f172a; font-weight:700; cursor:pointer;">Cancel</button>
                <button id="logoutConfirmBtn"
                    style="padding:8px 14px; border-radius:10px; border:none; background:#fb923c; color:#fff; font-weight:700; cursor:pointer;">Logout</button>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\inventory-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>