...
<?php if($isAdmin && request()->is('admin*')): ?>
<style>
...
<div class="top-notif" aria-live="polite">
    <button id="topNotifBtn" title="Notifications" aria-haspopup="true" aria-expanded="false">
        ...
        <span id="notif_badge" class="badge" style="display:<?php echo e($totalPending ? 'inline-block' : 'none'); ?>"><?php echo e($totalPending); ?></span>
    </button>

    <div id="topNotifDropdown" class="dropdown" role="menu" aria-hidden="true">
        <div class="dropdown-header">
            <h3>Notifications</h3>
            <div class="subtitle"><?php echo e($totalPending > 0 ? $totalPending . ' new notifications' : 'No new notifications'); ?></div>
        </div>

        <div class="notifications-list">
            <?php if($totalPending > 0): ?>
                <?php if($pendingRequests > 0): ?>
                    <a href="/admin/requests" class="notification-item <?php echo e($pendingRequests > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message">You have <?php echo e($pendingRequests); ?> pending stock request<?php echo e($pendingRequests !== 1 ? 's' : ''); ?> that need your attention</div>
                            <div class="notification-time">View all requests</div>
                        </div>
                        <div class="notification-count"><?php echo e($pendingRequests); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($pendingPR > 0): ?>
                    <a href="/admin/password-reset" class="notification-item <?php echo e($pendingPR > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($pendingPR); ?> user<?php echo e($pendingPR !== 1 ? 's' : ''); ?> requesting password reset</div>
                            <div class="notification-time">Review password requests</div>
                        </div>
                        <div class="notification-count"><?php echo e($pendingPR); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($lowStock > 0): ?>
                    <a href="/admin/stocks" class="notification-item <?php echo e($lowStock > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($lowStock); ?> item<?php echo e($lowStock !== 1 ? 's' : ''); ?> running low on stock (≤5 units)</div>
                            <div class="notification-time">Check inventory levels</div>
                        </div>
                        <div class="notification-count"><?php echo e($lowStock); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($outStock > 0): ?>
                    <a href="/admin/stocks" class="notification-item <?php echo e($outStock > 0 ? 'unread' : ''); ?>">
                        <div class="notification-avatar stock">
                            <svg viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($outStock); ?> item<?php echo e($outStock !== 1 ? 's' : ''); ?> completely out of stock</div>
                            <div class="notification-time">Urgent: Restock needed</div>
                        </div>
                        <div class="notification-count"><?php echo e($outStock); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($urgentOutbounds > 0): ?>
                    <a href="/admin/summary?type=urgent" class="notification-item <?php echo e($urgentOutbounds > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($urgentOutbounds); ?> urgent request<?php echo e($urgentOutbounds !== 1 ? 's' : ''); ?> awaiting approval</div>
                            <div class="notification-time">Review urgent requests</div>
                        </div>
                        <div class="notification-count"><?php echo e($urgentOutbounds); ?></div>
                    </a>
                <?php endif; ?>

                <?php if($expiringItems > 0): ?>
                    <a href="/admin/stocks" class="notification-item <?php echo e($expiringItems > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($expiringItems); ?> item<?php echo e($expiringItems !== 1 ? 's' : ''); ?> expiring within 7 days</div>
                            <div class="notification-time">Check expiry dates</div>
                        </div>
                        <div class="notification-count"><?php echo e($expiringItems); ?></div>
                    </a>
                <?php endif; ?>
                ...
                <?php if($failedJobs > 0): ?>
                    <a href="/admin/system-health" class="notification-item <?php echo e($failedJobs > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($failedJobs); ?> failed job<?php echo e($failedJobs !== 1 ? 's' : ''); ?> detected</div>
                            <div class="notification-time">Check system status</div>
                        </div>
                        <div class="notification-count"><?php echo e($failedJobs); ?></div>
                    </a>
                <?php endif; ?>
            <?php else: ?>
        ...
        <div class="dropdown-footer">
            <a href="<?php echo e(route('admin.notifications')); ?>">View All Notifications</a>
        </div>
    </div>
</div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\inventory-system\resources\views/partials/top-notifications.blade.php ENDPATH**/ ?>